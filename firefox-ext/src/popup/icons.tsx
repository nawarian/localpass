...
import { LogoSmallSvg, LogoSvg } from "../generated/logo";
...
/**
 * LocalPass brand mark, generated by `make icons` from core/logo.svg — the
 * same file rasterised for the toolbar/AMO PNGs, so the two can't drift.
 * `small` renders core/logo-small.svg, the heavier flat variant meant for
 * ~16–32px.
 */
export const Logo = ({ class: cls, small }: { class: string; small?: boolean }) =>
  small ? <LogoSmallSvg class={cls} /> : <LogoSvg class={cls} />;
